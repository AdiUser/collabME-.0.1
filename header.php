...
<nav class="navbar navbar-inverse">
    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">CollabME</a>
          ...
          ?>
              ...
              <hr>
                ...
                <h3><a href="profile.php"><?=$rm['user_id']?></a><br><small><a href="details.php">@<?php echo $rm['project_id']?></a></small></h3>
                   ...
                   <a href="clogs/accept.php?project_id=<?=$rm['project_id']?>&request_user=<?=$rm['user_id']?>" class="btn btn-success pull-center">Accept</a>
